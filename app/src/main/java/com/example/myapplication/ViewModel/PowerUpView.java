...
public class PowerUpView extends View {
    ...
    public PowerUpView(Context context, float x, float y, float scale, int spriteResourceId) {
        super(context);
        this.x = x;
        this.y = y;
        this.scale = scale;
        ...
        // Scale the sprite
        powerUpSprite = Bitmap.createBitmap(originalSprite, 0, 0,
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawBitmap(powerUpSprite, x, y, null);
    }
    ...
    public Bitmap getPowerUpSprite() {
